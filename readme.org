...
This repo adds a togglable "Game" layer, which doesn't have modkeys or other shortcuts, and is activated with the previously unused leftmost centre button of the mouse layer. 
The button toggles the layer until the exit_game_button as shown below is pressed, the rightmost top button.

The layout is as follows:

- 1, 2, 3, 4, exit_game_layer
- lshift, a, w, d, f
- lalt, q, s, e, tab
- esc, lctrl, space

This branch additionally swaps the navigation and mouse layer buttons in the thumb cluster.
