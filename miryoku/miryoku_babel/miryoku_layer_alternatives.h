...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              &u_tog_U_GAME,     &kp F7,            &kp F8,            &kp F9,            &kp F12,           \
...
&kp F12,           &kp F7,            &kp F8,            &kp F9,            &u_tog_U_GAME,     U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
